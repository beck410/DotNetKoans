...
namespace DotNetKoans.CSharp
{
    ...
    public class AboutMethods : Koan
    {
        ...
        {
          Assert.Equal(new string[]{"Cory","Will","Cory"}, this.MethodWithVariableArguments("Cory", "Will", "Cory"));
        }
        ...
        {
            Assert.Equal(new string[] {"Cory","Will","Cory"}, this.LocalMethodWithVariableParameters("Cory", "Will", "Cory"));
        }
